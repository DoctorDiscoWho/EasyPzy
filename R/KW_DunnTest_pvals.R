...
KW_DunnTest_pvals<- function(x, VC1_col, VC2_col, p.adj.method) {
  ...
  Kruskal_result3<-setNames(Kruskal_result3, replace(names(Kruskal_result3), 1:3, c("Test", VC1_col, "Formula/Group")))
  Dunntest_result3<-setNames(Dunntest_result3, replace(names(Dunntest_result3), 1:3, c("Test", VC1_col, "Formula/Group")))


  return(rbind(Kruskal_result3, Dunntest_result3))
}
